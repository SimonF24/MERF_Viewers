 ...
 */
export function setupProgressiveRendering(gCamera, view, lowResFactor) {
  ...
  let fullScreenPlane =
      new THREE.PlaneGeometry(view.offsetWidth, view.offsetHeight);
 ...
 */
export function renderProgressively(gCamera, gDisplayMode, gRayMarchScene, gRenderer, gStepMult) {
