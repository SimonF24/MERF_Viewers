 ...
 */
export function setupCameraControls(gCamera, gOrbitControls, gPointerLockControls, mouseMode, view) {
  ...
  return [gOrbitControls, gPointerLockControls];
}
 ...
 */
export function updateCameraControls(gCamera, gOrbitControls, gPointerLockControls) {
  if (gOrbitControls) {
